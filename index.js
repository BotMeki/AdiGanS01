...
const groupwa = 'https://chat.whatsapp.com/GGogTiqGWSjFK4xNfuv53b'10; // OFFICIAL GRUP LU 1
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] LENT Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @mrLent`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @mrLent`)
})
...
conn.sendMessage(id, 'Owner AdiGanz wa.me/+6285591654034' ,MessageType.text);
}
else if (text == 'AdiGanz'){
conn.sendMessage(id, 'Aku BOT nya Adi' ,MessageType.text);
}
else if (text == 'Chichi'){
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6285591654034* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text);
}
...
conn.sendMessage(id, 'kawan1 Putra wa.me/+6289625176924' ,MessageType.text);
}
else if (text == '.coowner'){
conn.sendMessage(id, 'kawan2 sum wa.me/+628557231695' ,MessageType.text);
}
else if (text == '.groupbot'){
conn.sendMessage(id, 'group bot whatsapp https://chat.whatsapp.com/GGogTiqGWSjFK4xNfuv53b' ,MessageType.text);
}
else if (text == '.tools1'){
...
conn.sendMessage(id, ' _TERIMAKASIH TELAH MENGGUNAKAN BOT LENT UNUK MEMBUAT BOT LENT BOT TELAH MENYEDIAKAN TUTORIAL CEK CHANEL MASLENT YT' ,MessageType.text);
}
else if (text == '.tools1'){
